        ...
        <div className="action-buttons mt-4 flex gap-2 items-center">
          ...
          {candidateId && (
            <button
              ...
              disabled={loading}
              className="action-btn px-3 py-1 text-sm bg-gray-100 hover:bg-gray-200 rounded border transition"
            >
          ...
          {candidateId && (
            <button
              ...
              disabled={loading}
              className="action-btn px-3 py-1 text-sm bg-red-100 hover:bg-red-200 text-red-700 rounded border border-red-300 transition"
            >
