...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* MAIN ROW: LEFT (Quick Actions + Recent Activity) | RIGHT (Charts) */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">

        {/* LEFT COLUMN */}
        <div className="flex flex-col gap-6">

          {/* Quick Actions (smaller now) */}
          ...
          {/* Recent Activity moved directly under Quick Actions */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        {/* RIGHT COLUMN — charts stay EXACTLY where they were */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 self-start">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Candidate Sources & Pipeline</h2>
          <TrafficChart />
        </div>
